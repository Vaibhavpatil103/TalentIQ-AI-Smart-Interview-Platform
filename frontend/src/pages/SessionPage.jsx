...
import { Code2Icon, Loader2Icon, LogOutIcon, PenToolIcon, PhoneOffIcon } from "lucide-react";
              ...
              <Panel defaultSize={50} minSize={20}>
                <div className="h-full overflow-y-auto bg-base-200">
                  ...
                  <div className="p-6 bg-base-100 border-b border-base-300">
                    ...
                    {/* Tab violation alert for host */}
                    {isHost && tabViolations > 0 && (
                      <TabViolationAlert count={tabViolations} />
                    )}
                  </div>
